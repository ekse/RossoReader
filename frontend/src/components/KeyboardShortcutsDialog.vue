    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
      ...
      <div class="space-y-3">
        <div class="flex items-center justify-between py-2 px-3 rounded-md bg-gray-50 dark:bg-gray-700/50">
          ...
          <kbd
            class="px-2 py-0.5 text-xs font-mono font-semibold bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded shadow-sm">r</kbd>
        </div>
        <div class="flex items-center justify-between py-2 px-3 rounded-md bg-gray-50 dark:bg-gray-700/50">
          <span class="text-sm text-gray-700 dark:text-gray-300">Mark all as read</span>
