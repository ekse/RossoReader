...
export const useItemsStore = defineStore('items', () => {
  ...
  return {
    items, total, page, loading, hasMore,
    filterFeedId, filterRead, filterStarred,
    loadItems, loadMore, toggleRead, toggleStarred,
    setFilterFeedId, setFilterRead, setFilterStarred,
  }
})
